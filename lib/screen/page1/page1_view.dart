                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: _controller
                            .getColorFromName(_controller.selectedColor)
                            .withOpacity(0.1),
                        borderRadius: BorderRadius.circular(12),
                        border: Border.all(
                          color: _controller.getColorFromName(
                            _controller.selectedColor,
                          ),
                        ),
                      ),
                      child: Row(
                ...
                child: Column(
                  children: [
                    ...
                    Slider(
                      ...
                      max: 100,
                      divisions: 100,
                      activeColor: _controller.getColorFromName(
                        _controller.selectedColor,
                      ),
                  ...
                  children: [
                    ...
                    ElevatedButton.icon(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: _controller.getColorFromName(
                          _controller.selectedColor,
                        ),
              ...
              _buildSectionCard(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildSummaryItem(
                      'Giá trị slider',
                      '${_controller.sliderValue.round()}',
                    ),
                    _buildSummaryItem(
                      'Chế độ nâng cao',
                      _controller.switchValue ? 'Bật' : 'Tắt',
                    ),
